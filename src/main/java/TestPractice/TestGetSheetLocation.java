...
public class TestGetSheetLocation {
...
//	public String key;
	...
	public static String parentSheetSheetName = "ProductList";
	public static String parentSheetFilePathColHeader = "ProductTestDataFilepath"; 
	
	public static Logger logger = LogManager.getLogger(TestGetSheetLocation.class);

	public static ArrayList<String> getExcellRowData(String ProductName) throws Exception {
...
//		System.out.println(configPath);
		...
		try {
			...
			for (int i = 0; i < noOfSheets; i++) {
				 ...
				 */
				if (workBook.getSheetName(i).equalsIgnoreCase(parentSheetSheetName)) {
...
//				System.out.println(column);
	...
	public static String getCellData(String ProductName) {
		/*
		...
		try {
			arrayData = getExcellRowData(ProductName);
			ItRows = currentSheet.iterator();
			row = ItRows.next();
			itCell = row.iterator();
			...
			while (itCell.hasNext()) {
				...
				if (cell.getStringCellValue().equalsIgnoreCase(parentSheetFilePathColHeader)) {
					column = k;
					break;
				}
				k++;
...
//		String productname = "Activ Health Enhanced";
		...
		String productExcelFilePath = getCellData(productName);
		String productSheetFilePath = rootPath + productExcelFilePath;
		
//		System.err.println(" Sheet Location : " + productSheetFilePath);
		return productSheetFilePath;
	}
